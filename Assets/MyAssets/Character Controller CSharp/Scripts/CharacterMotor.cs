...
public class CharacterMotor : MonoBehaviour
{
    ...
    protected Vector3 ApplyInputVelocityChange(Vector3 velocity)
    {
        if (!canControl)
    ...
    protected Vector3 ApplyGravityAndJumping(Vector3 velocity)
    {
    ...
    {
        if (hit.normal.y > 0 && hit.normal.y > groundNormal.y && hit.moveDirection.y < 0.0f)
        {
    ...
    protected IEnumerator SubtractNewPlatformVelocity()
    {
    ...
    protected bool MoveWithPlatform()
    {
        return (
    ...
    protected Vector3 GetDesiredHorizontalVelocity()
    {
        // Find desired velocity
    ...
    protected Vector3 AdjustGroundVelocityToNormal(Vector3 hVelocity, Vector3 groundNormal)
    {
        Vector3 sideways = Vector3.Cross(Vector3.up, hVelocity);
        return Vector3.Cross(sideways, groundNormal).normalized * hVelocity.magnitude;
    }

    protected bool IsGroundedTest()
    {
    ...
    public float CalculateJumpVerticalSpeed(float targetJumpHeight)
    {
        ...
        return Mathf.Sqrt(2.0f * targetJumpHeight * movement.gravity);
    }
